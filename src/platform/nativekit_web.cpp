...
nk_capabilities NK_CALL nk_get_capabilities(void) {
    return NK_CAP_WINDOW | NK_CAP_INPUT | NK_CAP_OPENGL_ES_SURFACE | NK_CAP_CURSOR |
           NK_CAP_POINTER_CAPTURE | NK_CAP_CLIPBOARD | NK_CAP_DRAG_DROP | NK_CAP_WINDOW_GEOMETRY |
           NK_CAP_WINDOW_STYLING | NK_CAP_SHELL | NK_CAP_SYSTEM_APPEARANCE | NK_CAP_NOTIFICATION |
           NK_CAP_JOYSTICK | NK_CAP_RESOURCE_SHARING | NK_CAP_RESOURCE_IO | NK_CAP_ACCESSIBILITY;
}
