...
NK_API nk_result NK_CALL nk_core_graphics_image_register(
...
NK_API nk_result NK_CALL nk_core_graphics_image_get_backend(
    nk_graphics_image image, nk_graphics_image_info *out_info NK_OUT,
    const void **out_runtime NK_OUT, uint64_t *out_backend_image NK_OUT);
