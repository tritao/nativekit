...
nk_result NK_CALL nk_surface_destroy(nk_handle) { return unsupported_graphics(); }
nk_result NK_CALL nk_surface_show(nk_handle, uint32_t) { return unsupported_graphics(); }
