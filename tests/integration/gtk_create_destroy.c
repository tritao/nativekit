...
int main(void) {
    ...
    const nk_capabilities expected =
        ...
        NK_CAP_WINDOW_CUSTOM_DECORATIONS | NK_CAP_MONITOR | NK_CAP_MONITOR_FULLSCREEN |
        NK_CAP_RESOURCE_SHARING | NK_CAP_RESOURCE_IO | NK_CAP_VULKAN_SURFACE |
        NK_CAP_WRAP_NATIVE_WINDOW | NK_CAP_SURFACE_FRAME_CALLBACK | NK_CAP_NATIVE_VIEW |
        NK_CAP_FILE_WATCH | NK_CAP_CLIPBOARD_WATCH | NK_CAP_DYNAMIC_LIBRARY;
