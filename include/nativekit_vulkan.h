...
NK_API nk_result NK_CALL nk_vulkan_get_required_instance_extensions(
    nk_window window, const char **NK_NULLABLE extensions NK_OUT_UTF8_ARRAY(inout_count),
 ...
 */
NK_API nk_result NK_CALL nk_vulkan_create_surface(nk_window window, void *instance,
