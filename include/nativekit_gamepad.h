...
NK_API nk_result NK_CALL nk_gamepad_is_mapped(nk_joystick joystick, nk_bool *out_mapped);
/** Reports whether the active mapping is built-in or application-supplied. */
NK_API nk_result NK_CALL nk_gamepad_get_mapping_source(nk_joystick joystick,
...
NK_API nk_result NK_CALL nk_gamepad_get_name(nk_joystick joystick, char *buffer,
                                             uint32_t *inout_size);
/** Returns the current normalized state of a mapped joystick. */
NK_API nk_result NK_CALL nk_gamepad_get_state(nk_joystick joystick, nk_gamepad_state *out_state);
