 ...
 */
NK_API nk_result NK_CALL nk_monitor_list(nk_monitor *monitors, uint32_t *inout_count);
/** Returns the primary monitor handle. */
NK_API nk_result NK_CALL nk_monitor_get_primary(nk_monitor *out_monitor NK_OUT);
/** Copies the monitor name into a caller-owned UTF-8 buffer. */
NK_API nk_result NK_CALL nk_monitor_get_name(nk_monitor monitor,
...
NK_API nk_result NK_CALL nk_monitor_get_geometry(nk_monitor monitor,
                                                 nk_monitor_geometry *out_geometry NK_OUT);
/** Returns the mode currently selected by the monitor compositor. */
NK_API nk_result NK_CALL nk_monitor_get_current_mode(nk_monitor monitor,
...
NK_API nk_result NK_CALL nk_window_set_fullscreen_monitor(nk_window window, nk_monitor monitor);
