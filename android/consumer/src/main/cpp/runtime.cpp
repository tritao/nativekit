...
Java_io_nativekit_consumer_MainActivity_nativeCapabilityContractProbe(JNIEnv *, jclass) {
    const nk_capabilities expected =
        ...
        NK_CAP_SURFACE_FRAME_CALLBACK | NK_CAP_SENSORS | NK_CAP_HAPTICS |
        NK_CAP_GAMEPAD_RUMBLE | NK_CAP_HTTP_CLIENT | NK_CAP_HTTP_STREAMING | NK_CAP_TRANSPORT |
        NK_CAP_DYNAMIC_LIBRARY;
