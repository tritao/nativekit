...
class NativeKitTextInput {
	...
	public static function state(text:String, textStart:Int, documentLength:Int,
		...
		value.set_input_type(inputType == null ? NativeKitConstants.NK_TEXT_INPUT_TEXT : inputType);
		value.set_flags(flags == null ? 0 : flags);
		value.set_action(action == null ? NativeKitConstants.NK_TEXT_INPUT_ACTION_DEFAULT : action);
