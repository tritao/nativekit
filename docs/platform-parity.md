...
| iOS | Mobile host, WebView, Metal, input, resource I/O, platform identity, application paths, application storage, keep-awake, device/display orientation | Dialogs, clipboard, drag/drop, shell, appearance, notifications, resource sharing, joystick, accessibility, system fonts |
