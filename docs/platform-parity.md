...
| iOS | Mobile host, WebView, dialogs, Metal, input, clipboard, shell, appearance, notifications, resource I/O, platform identity, application paths, application storage, keep-awake, device/display orientation | Drag/drop, resource sharing, joystick, accessibility, system fonts |
