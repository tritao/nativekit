...
| iOS | Mobile host, Metal, resource I/O, platform identity, application paths, application storage, keep-awake, device/display orientation | WebView, dialogs, clipboard, drag/drop, shell, appearance, notifications, input, resource sharing, joystick, accessibility, system fonts |
