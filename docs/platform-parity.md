...
| iOS | Mobile host, WebView, Metal, input, clipboard, shell, appearance, notifications, resource I/O, platform identity, application paths, application storage, keep-awake, device/display orientation | Dialogs, drag/drop, resource sharing, joystick, accessibility, system fonts |
