...
#define SG_GL_FUNCS_EXT                                                                   \
    _SG_XMACRO(glCopyBufferSubData, void, (GLenum read_target, GLenum write_target,         \
                                           GLintptr read_offset, GLintptr write_offset,     \
                                           GLsizeiptr size))                                \
    _SG_XMACRO(glMapBufferRange, void *, (GLenum target, GLintptr offset, GLsizeiptr length, \
                                          GLbitfield access))                                \
