...
#if defined(NK_SOKOL_BACKEND_GLES3)
    return nkgpu_surface_create_for_api(window, NK_GRAPHICS_OPENGL_ES, width, height, out);
#else
    return nkgpu_surface_create_for_api(window, NK_GRAPHICS_OPENGL, width, height, out);
#endif
}
