...
enum { NKUI_LAYOUT_NODE_BOX = 1, NKUI_LAYOUT_NODE_TEXT = 2, NKUI_LAYOUT_NODE_BUTTON = 3 };
...
enum { NKUI_LAYOUT_EVENT_BUTTON_ACTIVATED = 1 };
...
NKUI_API nkui_result NK_CALL nkui_layout_session_get_event_count(nkui_layout_session session,
                                                                 uint32_t *out_count NK_OUT);

/** Reads one event from the most recent submission. */
NKUI_API nkui_result NK_CALL nkui_layout_session_get_event(nkui_layout_session session,
                                                           uint32_t index,
                                                           nkui_layout_event *out_event NK_OUT);

/** Returns resolved bounds for a node from the most recent submission. */
NKUI_API nkui_result NK_CALL nkui_layout_session_get_item(nkui_layout_session session,
                                                          uint32_t node_id,
                                                          nkui_layout_item *out_item NK_INOUT);
